...
class FeaExpand(nn.Module):
    ...
    def __init__(self, expansion=3, mode='1', in_channels=None, thres=None):
        ...
        elif '10c-symmetric' == self.mode:
            init = thres[0]
            # learnable_thres
            self.thres = nn.Parameter(torch.ones(1, in_channels, 1, 1) * init, requires_grad=True)
    ...
    def forward(self, x):
        ...
        elif '10-symmetric' == self.mode or '10c-symmetric' == self.mode:
